...
def full_war():
    ...
    while len(player1) > 0 and len(player2) > 0: #and total == 52:
        ...
        print("---------------------------")
        print("Player1 number of cards:", len(player1),": ")
##        for card in player1:
##            print(card, end = " ")
##        print ('\n')
        print("Player2 number of cards:", len(player2),": ")
##        for card in player2:
##            print(card, end = " ")
##        print ('\n')
        ...
        #test = input("Hit enter to continue...\n\n")
...
# glitches: 
#           war doesn't work
#           currently an infinite loop? because the hands never run out of cards
